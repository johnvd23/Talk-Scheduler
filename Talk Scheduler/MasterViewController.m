...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    OrgViewController *orgViewController = [[OrgViewController alloc] initWithMasterViewController:self org:org];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.text = [[managedObject valueForKey:@"city"] description];
...
-(void)insertOrgWithName:(NSString *)name address:(NSString *)address city:(NSString *)city state:(NSString *)state
{
    ...
    [newManagedObject setValue:address forKey:@"address"];
    [newManagedObject setValue:city forKey:@"city"];
    [newManagedObject setValue:state forKey:@"state"];
